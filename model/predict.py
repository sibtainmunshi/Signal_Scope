...
def predict(image_path, checkpoint=None):
    checkpoint = checkpoint or os.getenv("SIGNALSCOPE_CHECKPOINT", "model/checkpoints/cifake_resnet18_v1/best.pt")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", default=os.getenv("SIGNALSCOPE_CHECKPOINT", "model/checkpoints/cifake_resnet18_v1/best.pt"))
