...
| Overall and unseen-generator AUC, macro-F1, confusion matrix, accuracy, FPR | Implemented and finalised | Frozen publicly (`report/final/freeze.json`), then scored once: CIFAKE test 20k AUC 0.9926 / macro-F1 0.951 / FPR 1.9%; reserved unseen GLIDE+DALLE mean AUC 0.565 as distributed and 0.643 format-matched, real FPR 10.4-14.6%. Baseline v0.1.0 on the same reserved set: 0.548 / 0.546. Never claim organizer hidden results. |
