...
| A: Faithful explanation | Native crop Grad-CAM + masking; automated 40-image audit complete; two human reviewers pending; artifact annotations unavailable |
...
| Public repository / weights | v0.2.0 packaging in progress; verify asset URL before pushing main manifest |
| Fresh clone under about 10 minutes | v0.1.0 verified in 257.2 seconds; repeat for v0.2.0 with independent CPU environment |
...
| 3-5 minute recorded demo | Pending actual-inference recording and public video link |
