...
type Metrics = { roc_auc: number | null; macro_f1: number; accuracy: number; false_positive_rate: number | null; count: number; split: string; confusion_matrix: number[][]; unseen_generator_auc: number | null }
type ModelReport = { ready: boolean; architecture?: string; model_version?: string; image_size?: number; source_resolution?: string; threshold?: number; calibrated?: boolean; metrics: Metrics | null; checkpoint_sha256?: string; unseen_generator_status?: string; external_development?: { macro_generator_roc_auc: number; per_generator: { generator: string; roc_auc: number; accuracy: number; false_positive_rate: number }[] } | null }
